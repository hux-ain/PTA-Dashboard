        ...
        <div class="col-lg-8">
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-body p-4">
                    <form action="{{ isset($record) ? route('p2p.update', $record->id) : route('p2p.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('link_name') is-invalid @enderror"
                                   id="link_name" name="link_name" value="{{ old('link_name', $record->link_name ?? '') }}" required>
                            @error('link_name')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('station_a') is-invalid @enderror"
                                   id="station_a" name="station_a" value="{{ old('station_a', $record->station_a ?? '') }}" required>
                            @error('station_a')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('station_b') is-invalid @enderror"
                                   id="station_b" name="station_b" value="{{ old('station_b', $record->station_b ?? '') }}" required>
                            @error('station_b')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('status') is-invalid @enderror"
                                   id="status" name="status" value="{{ old('status', $record->status ?? '') }}" placeholder="e.g., Active, Down">
                            @error('status')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('ownership') is-invalid @enderror"
                                   id="ownership" name="ownership" value="{{ old('ownership', $record->ownership ?? '') }}" placeholder="e.g., Own, Leased">
                            @error('ownership')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('frequency') is-invalid @enderror"
                                   id="frequency" name="frequency" value="{{ old('frequency', $record->frequency ?? '') }}">
                            @error('frequency')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
