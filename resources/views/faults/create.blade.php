    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('faults.index') }}" class="btn btn-outline-secondary">
                    ...
                    <form action="{{ isset($record) ? route('faults.update', $record->id) : route('faults.store') }}" method="POST">
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-primary fw-semibold">
                                <i class="fa-solid fa-check me-2"></i>Save Fault Report
                            </button>
                            <a href="{{ route('faults.index') }}" class="btn btn-secondary">
