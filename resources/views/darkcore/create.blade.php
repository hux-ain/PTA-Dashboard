        ...
        <div class="col-lg-8">
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-body p-4">
                    <form action="{{ isset($record) ? route('darkcore.update', $record->id) : route('darkcore.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('point_a') is-invalid @enderror"
                                       id="point_a" name="point_a" value="{{ old('point_a', $record->point_a ?? '') }}" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('point_b') is-invalid @enderror"
                                       id="point_b" name="point_b" value="{{ old('point_b', $record->point_b ?? '') }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('service_provider_name') is-invalid @enderror"
                                   id="service_provider_name" name="service_provider_name" value="{{ old('service_provider_name', $record->service_provider_name ?? '') }}" required>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('service_type') is-invalid @enderror"
                                       id="service_type" name="service_type" value="{{ old('service_type', $record->service_type ?? '') }}">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('own_or_lease') is-invalid @enderror"
                                       id="own_or_lease" name="own_or_lease" value="{{ old('own_or_lease', $record->own_or_lease ?? '') }}" placeholder="e.g., Own, Lease">
